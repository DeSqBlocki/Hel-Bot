...
const TwitchClient = new tmi.Client({
    ...
    identity: {
        ...
        password: `oauth:${process.env.TTV_Token}`
    },
    channels: channels
})
...
async function generateToken() {
    let scopes = ["chat:read", "chat:edit", "moderator:manage:chat_settings", "channel:manage:vips"];
...
async function newShoutout(userID){
...
//     }
//     const conditions = [{
//         broadcaster_user_id: String(await getIDByName("x__hel__x")) //x__hel__x
//     }]
